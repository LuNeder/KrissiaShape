...
3D model of the shape my [physics 2 teacher](https://krissia-zawadzki.owlstown.net/) made on her class

(See also my [blog post](https://luana.dev.br/2025/09/20/KrissiaShape.html) about this)

![Rendered preview of the shape in OpenSCAD, it's a pyramid with a trapezoid-like shape glued to its right](.images/shape.png)
...
![thales theorem drawing of a triangle](.images/tales.jpg)
...
![Thales theorem calculation of the aforementioned size](.images/miguel.jpg)
...
![Calculating the relative positions of the vertices of the trapezoid at height d related to the pyramid](.images/radio.jpg)
...
![Image of the shape in my tablet again, now shoing an angle theta for the right wall of the shape](.images/theta.jpg)
...
![OpenSCAD screenshot showing the final shape and the full OpenSCAD window](.images/finalcad.png)
...
![the shape drawn on a blackboard](.images/original.png)

![a piece of paper full of random drawings and calculations](.images/draft.jpg)
